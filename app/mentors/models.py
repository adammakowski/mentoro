...
class Mentor(models.Model):
    ...
    what_can_i_teach_you = RichTextField(blank=False, null=False, verbose_name='Czego nauczę')
    requirements = RichTextField(blank=False, null=False, verbose_name='Wymagania od ucznia')
